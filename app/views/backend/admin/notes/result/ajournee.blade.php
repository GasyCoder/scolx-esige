...
<hr>
    <div class="px-7 py-2 flex justify-center">
        <center class="pb-0">
        <br>
        <h5>LISTE DES ETUDIANTS A JOURNEE</h5>
        <p class="font-bold">2ème session</p>
        <p>Niveau: <b>{{$class->name}}</b> | Parcours: <b>{{$parcour->name}}</b></p>
    ...
    ?>
      ...
      <tr>
        ...
        <td class="text-center">
         @if($affichage->admis == 0)A journée @endif
        </td>
      </tr>
