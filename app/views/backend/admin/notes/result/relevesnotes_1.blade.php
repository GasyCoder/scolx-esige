...
<body style="color:#000;background:#fff;">
    ...
    (S1-S2) 
    <p>Année d'étude - {{$years->yearsUniv}} - <span style="border:1px dotted red">Session 1</span></p>
    @endif
    </center>
    </span>
  ...
  <div class="flex justify-between"> 
    ...
    <p style="margin-left:3.2rem">Fait à Mahajanga, le_________________<br></p>
</div>
</div><br>
    <center style="text-align:center;display:;">
        <small class="footer_tb">
        <i>Ce relevé de notes ne doit être remis en aucun cas à l’intéressé sous peine d’annulation.</i><hr>
