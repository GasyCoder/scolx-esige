...
@include('backend.break')
        ...
        <div class="grid lg:grid-cols-3 gap-5">
            ...
            <div class="card p-5">
                    <h3>Listes des Semestres Universitaire</h3>
                    <table class="table table_striped w-full mt-3">
                        <thead>
                            <tr>
                                <th class="ltr:text-left rtl:text-right ">#</th>
                                <th class="ltr:text-left rtl:text-right ">Code Semestre</th>
                        ...
                        @foreach($semestres as $sem)
                            <tr>
                                ...
                                <div class="inline-flex ltr:ml-auto rtl:mr-auto">
                                    ...
                                    <a onclick="return confirm('{{ Lang::get($path.'.delete') }}')" href="{{ URL::route('deleteP', $sem->id) }}" class="btn btn-icon btn_outlined btn_danger ltr:ml-2 rtl:mr-2">
...
{{ Form::open(['route'=>['updateSem',$getSemestre->id], 'class'=>'', 'id'=>'myForm2', 'data-toggle'=>'validator'])  }}
                    ...
                    <div class="mb-5">
                      ...
                      {{ Form::close() }}
@include('backend.admin.administration.Semestres.jsUp')
                </div>
            </div>
<?php } } else { ?>
            ...
            <div class="flex flex-col gap-y-5 lg:col-span-2 xl:col-span-1">
                ...
                <div class="card p-5 flex flex-col gap-y-5">
                    ...
                    {{ Form::open(['route'=>'storeSem', 'class'=>'', 'id'=>'myForm', 'data-toggle'=>'validator']) }} 
                                           <div class="mb-5">
                            <label class="label block mb-2" for="title">Code Semestre</label>
                            <input id="codeSem" name="codeSem" type="text" class="form-control" placeholder="example : S1 ou S2">
                        </div>
                        <div class="mb-5">
                            <label class="label block mb-2" for="semestre">Intitulé</label>
                            <div class="custom-select">
                ...
                {{ Form::close() }}
                @include('backend.admin.administration.Semestres.jsAdd')
                </div>
            </div>
<?php }  ?>   
        </div>
