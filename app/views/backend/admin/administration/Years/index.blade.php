                        ...
                        @foreach($years as $year)
                            <tr>
                                ...
                                <div class="inline-flex ltr:ml-auto rtl:mr-auto">
                                    ...
                                    <a onclick="return confirm('{{ Lang::get($path.'.delete') }}')" href="{{ URL::route('deleteP', $year->id) }}" class="btn btn-icon btn_outlined btn_danger ltr:ml-2 rtl:mr-2">
...
{{ Form::open(['route'=>['updateYear',$getYear->id], 'class'=>'', 'id'=>'myForm2', 'data-toggle'=>'validator'])  }}
                      ...
                      {{ Form::close() }}
@include('backend.admin.administration.Years.jsUp')
                </div>
            </div>
<?php } } else { ?>
            ...
            <div class="flex flex-col gap-y-5 lg:col-span-2 xl:col-span-1">
                ...
                {{ Form::close() }}
                @include('backend.admin.administration.Years.jsAdd')
                </div>
            </div>
<?php }  ?>   
        </div>
