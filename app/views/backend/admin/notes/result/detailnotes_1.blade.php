...
<head>
    ...
    <title>Détails notes | Semestre 1</title>
    <!-- Generics -->
...
<body style="color:#000">
    ...
    ?> 
      ...
      <tr style="color:#0C4A6E;">
       ...
       <td width="580">
        ...
        <td>    
        <table class="table_bordered" width="100%">
        <?php $moyenne = $totalPondere/$CoefPondere ?>
          <tr style="line-height:12px;">
            @if($moyenne >= 10)
            <td style="color:green;font-weight:bold" align="center">{{number_format($moyenne, 2, ',', '')}}</td>
            @else
            <td style="color:red;" align="center">{{number_format($moyenne, 2, ',', '')}}<br></td>
            @endif
          </tr>
        </table>
        </td>
        ...
        <?php $isvalide = $totalPondere/$CoefPondere ?>
          <tr style="line-height:12px;">
            @if($isvalide >= 10)
            <td style="color:green;font-weight:bold" align="center"> Validé @else <span style="color:red">Non validé</span><br></td>
            @endif
          </tr>
        </table>
        </td>
    ...
    @endforeach
      ...
      <tr style="font-weight:500;">
         <td colspan="4">Moyenne générale 1<sup>er</sup> semestre</td>
...
@endsection
 ...
 <!-- Sidebar -->
    <aside class="sidebar" id="btn-invoice">
        ...
        <!-- Tags -->
       <h2 class="p-5">Semestre 2</h2>
        <hr>
         <div class="flex flex-col gap-y-5 p-5">
            <a href="/admin/detailnotes/semestre_2/niveau/etudiants/{{$class->id.'/'.$parcour->id.'/'.$student->id}}" class="flex items-center text-normal">
