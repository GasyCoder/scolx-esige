...
@section('title') Les Classes @stop
@section('content') 
<!-- Workspace -->
...
@include('backend.break')
        ...
        <div class="grid lg:grid-cols-3 gap-5">
            ...
            <div class="card p-5">
                    <h3>Listes des classes <small class="font-bold">Total:({{(count($niveau))}})</small></h3>
                        ...
                        @foreach($niveau as $class)
                            <tr>
                                ...
                                <div class="inline-flex ltr:ml-auto rtl:mr-auto">
                                    ...
                                    <a onclick="return confirm('{{ Lang::get($path.'.delete') }}')" href="{{ URL::route('deleteP', $class->id) }}" class="btn btn-icon btn_outlined btn_danger ltr:ml-2 rtl:mr-2">
                ...
                <div class="card p-5 flex flex-col gap-y-5">
                  ...
                  <div id="resultajax2" class="center"></div>    
                   {{ Form::open(['route'=>['class_update',$getclass->id], 'class'=>'', 'id'=>'myForm2', 'data-toggle'=>'validator'])  }}    
                      ...
                      {{ Form::close() }}
@include('backend.admin.pedagogie.Niveau.jsUp')
                </div>
            </div>
...
<?php } } else { ?>
            ...
            <div class="flex flex-col gap-y-5 lg:col-span-2 xl:col-span-1">
                ...
                <div class="card p-5 flex flex-col gap-y-5">
                    ...
                    {{ Form::open(['route'=>'store_class', 'class'=>'', 'id'=>'myForm', 'data-toggle'=>'validator']) }} 
                        <div class="mb-5">
                            <label class="label block mb-2" for="title">Intitulé</label>
                ...
                {{ Form::close() }}
                @include('backend.admin.pedagogie.Niveau.jsAdd')
                </div>
            </div>
<?php }  ?>   
        </div>
