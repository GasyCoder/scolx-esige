...
?>
@section('title') Ajouter notes 2e session - S_2 @stop
@section('content')
        ...
        <div class="card p-5">
            <div class="overflow-x-auto">
                <table class="table-sorter table table-auto table_hoverable w-full">
                    ...
                    <tbody>
                    @foreach($semestreTwo as $key => $deliber)
                    <?php 
                    ...
                    @if($deliber->moyenne < 10)
                        <tr>
                           ...
                           @else
		                           <td class="font-bold text-center" style="color:#6769ad">
		                           			{{$deliber->stud->matricule}}
		                           </td>
		                           <td class="font-bold">
		                            	<span style="color:#6769ad">
		                            		{{$deliber->stud->fname.' '.$deliber->stud->lname }}
		                            	</span> 
		                           </td>
                           @endif
                           @if($dsexist > 0) 
                            ...
                            <td class="text-center">
                                <div class="inline-flex ltr:ml-auto rtl:mr-auto">
                                <a href="{{ URL::route('selectSession2', [$class->id, $parcour->id]).'/'.rtrim(strtr(base64_encode($deliber->id_student), '+/', '-_'), '=')}}" class="badge badge_primary" style="color:#fff">
    ...
    <aside class="sidebar">
        ...
        <div class="flex flex-col gap-y-5 p-5">
            <a href="#" class="flex items-center text-normal">
                ...
                Total étudiants
                <span class="badge badge_success ltr:mr-2 rtl:ml-2 ltr:ml-auto rtl:mr-auto">{{count($semestreTwo)}}</span>
            </a>
            <a href="#" class="flex items-center text-normal">
