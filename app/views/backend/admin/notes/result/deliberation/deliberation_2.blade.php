...
$delibera = Delibera::where('class_id', $class->id)
                        ...
                        ->first();
?>
@section('title') Activation Semestre 2 @stop
@section('content')
<!-- Workspace -->
...
<div class="container flex items-center justify-center py-10">
        <div class="w-full md:w-1/2 xl:w-1/3">
            <div class="card p-5">
                <h3>ACTIVATION SEMESTRE 2</h3>
                <div class="mt-5">
                   {{ Form::open(['route'=>['submitDeliber_2', $class->id, $parcour->id], 'class'=>'flex-shrink flex-wrap', 'id'=>'', 'data-toggle'=>''])  }} 
                    <div class="mb-5">
                            <label class="label block mb-2" for="title">Etudiants présents pour l'examen semestre 2</label>
                    ...
                    <div class="mt-10">
                            ...
                            <a href="/admin/resultats_examen/semestre_2/vérification/{{$class->id}}/{{$parcour->id}}" class="btn btn_primary"><i class="la la-undo"></i> Retour</a>
