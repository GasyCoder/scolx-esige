...
<main class="workspace workspace_with-sidebar">
        <section class="breadcrumb lg:flex items-start">
            ...
            <a href="/admin/notes/etudiants/notes/ajouter-1-session/{{$class->id}}/{{$parcour->id.'/1/'.rtrim(strtr(base64_encode($student->id), '+/', '-_'), '=')}}" class="btn btn-icon btn-icon_large btn_outlined btn_primary mt-5">
