...
class UEController extends BaseController {
	...
	public function index()
	{
		...
		if ($ues !== null) {
		return View::make('backend.admin.pedagogie.UE.index', compact('ues', 'classes', 'years', 'elements', 'parcours', 'semestres'))->with('title', $title)->with('sous', $sous);
		} 
	...
	public function UEtroncCommun($class)
	{
		...
		return View::make('backend.admin.pedagogie.UE.addUEtronc', compact('class','allParcours', 'allClasses', 'semestres'))->with('title', $title)->with('sous', $sous);
	}
	...
	public function ue_parcour($class)
	{
		...
		return View::make('backend.admin.pedagogie.UE.parcours', compact('parcours', 'semestres', 'class'))->with('title', $title)->with('sous', $sous);
	}
	...
	{	
		...
		return View::make('backend.admin.pedagogie.UE.updateUe', compact('ues', 'class','parcour', 'semestres', 'years'))->with('title', $title)->with('sous', $sous);
	}
	...
	{	
		...
		if ($ues !== null) {
			return View::make('backend.admin.pedagogie.UE.show', compact('ues', 'ues2', 'semestres', 'class', 'parcour', 'parcours', 'sem', 'ueAp'))->with('title', $title)->with('sous', $sous);
		} 
		else {
			return View::make('404');
		}
	...
	public function print_ue($class, $parcour)
	{
		...
		return View::make('backend.admin.pedagogie.UE.print', compact('class', 'parcour', 'ue_print_1', 'credit_one', 'ue_print_2', 'sumCredit_2'))->with('title', $title)->with('sous', $sous);
	}
